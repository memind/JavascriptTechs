...
import { idlFactory } from './MeminBank_assets.did.js';
export { idlFactory } from './MeminBank_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MEMINBANK_ASSETS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./MeminBank_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the MeminBank_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./MeminBank_assets.did.js")._SERVICE>}
 */
export const MeminBank_assets = createActor(canisterId);
