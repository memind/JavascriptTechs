...
/***/ "./src/declarations/MeminBank/index.js":
/*!*********************************************!*\
  !*** ./src/declarations/MeminBank/index.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MeminBank": () => (/* binding */ MeminBank),
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './MeminBank.did.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* provided dependency */ var process = __webpack_require__(/*! ./node_modules/process/browser.js */ "./node_modules/process/browser.js");
...
const canisterId = "6xhyy-ryaaa-aaaab-qacqa-cai";
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./MeminBank.did.js")._SERVICE>}
 */
...
See https://internetcomputer.org/docs/current/developer-docs/updates/release-notes/ for migration instructions`);
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(Object(function webpackMissingModule() { var e = new Error("Cannot find module './MeminBank.did.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the MeminBank canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./MeminBank.did.js")._SERVICE>}
 */
const MeminBank = createActor(canisterId);
...
"use strict";
/*!*******************************************!*\
  !*** ./src/MeminBank_assets/src/index.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_MeminBank__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/MeminBank */ "./src/declarations/MeminBank/index.js");


window.addEventListener("load", async function () {
  update(await _declarations_MeminBank__WEBPACK_IMPORTED_MODULE_0__.MeminBank.checkBalance());
});
...
async function transaction(transactionType, amount, button){
  ...
  if(amount){
    if(transactionType === "receive")
      await _declarations_MeminBank__WEBPACK_IMPORTED_MODULE_0__.MeminBank.receiveDollar(amount);
  
    if(transactionType === "withdraw") 
      await _declarations_MeminBank__WEBPACK_IMPORTED_MODULE_0__.MeminBank.withdrawDollar(amount);
  }
}
})();
